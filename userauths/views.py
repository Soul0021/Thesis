...
def quiz1(request, step=1):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'lesson/beginner1.html', {'quiz_data': quiz_data, 'correct': correct, 'incorrect': incorrect, 'correct_answer': correct_answer})
    else:
        return render(request, 'lesson/beginner1.html', {'quiz_data': quiz_data})
